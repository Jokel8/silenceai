...
<body>
    ...
    <script>
        // Scroll-based color transition for background
        const START_COLOR_HEX = getComputedStyle(document.documentElement).getPropertyValue('--color-primary-start').trim();
        const END_COLOR_HEX = getComputedStyle(document.documentElement).getPropertyValue('--color-primary-end').trim();
        const START_BG_HEX = getComputedStyle(document.documentElement).getPropertyValue('--color-background-start').trim();
        const END_BG_HEX = getComputedStyle(document.documentElement).getPropertyValue('--color-background-end').trim();
        ...
        document.body.addEventListener('scroll', () => {
            ...
            document.documentElement.style.setProperty('--current-primary', mixedPrimary.hex);
