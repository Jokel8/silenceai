...
class CropProcessor:
    ...
    def crop_and_resize_by_mask(self, img, mask, target_w, target_h):
        """
    ...
    def _intelligent_crop_coords(self, xs, ys, iw, ih, target_w, target_h):
        ...
        # Apply padding
        new_w = bbox_w * self.padding
        new_h = bbox_h * self.padding
        
        # Enforce minimum size
        min_side = int(round(min(iw, ih) * self.min_frac))
